...
function adsenseSettingsSave() {
    "use strict";
    
    let submitButton = $('#adsense_settings_button');
    let submitButtonLoading = $('#adsense_settings_button_loading');
    let form = $('#adsense_settings_form');
